...
def dataset_factory(dataset_list, **kwargs):
    ...
    for key in dataset_list:
        ...
        has_dense_depth = has_dense_depth and getattr(db, "has_dense_depth", True)
        db_list.append(db)

    dataset = ConcatDataset(db_list)
    dataset.has_dense_depth = has_dense_depth
    return dataset
