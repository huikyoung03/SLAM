...
if __name__ == '__main__':
    ...
    parser.add_argument("--imu_prior", type=str, default=None)
    parser.add_argument("--use_imu_residual", action="store_true")
    parser.add_argument("--imu_residual_weight", type=float, default=0.02)
    parser.add_argument("--imu_residual_window", type=int, default=12)
    parser.add_argument("--imu_residual_max_deg", type=float, default=45.0)
    parser.add_argument("--imu_residual_max_alpha", type=float, default=0.05)
    parser.add_argument("--imu_residual_max_frame_gap", type=int, default=30)
    parser.add_argument("--imu_residual_compose_order", type=str, default="prev_dq", choices=["prev_dq", "dq_prev"])
    parser.add_argument("--imu_residual_inverse", action="store_true")
    parser.add_argument("--imu_residual_debug", action="store_true")
    parser.add_argument("--imu_residual_debug_path", type=str, default=None)
